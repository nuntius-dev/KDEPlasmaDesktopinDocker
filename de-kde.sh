...
sudo apt install xfce4 xfce4-goodies zsh libreoffice zenity git curl wget gdebi lightdm chromium-browser firefox-esr feathernotes geany synaptic audacious parole xarchiver -y
